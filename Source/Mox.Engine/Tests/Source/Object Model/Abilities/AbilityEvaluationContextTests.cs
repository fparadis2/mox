...
{
    [TestFixture]
    public class AbilityEvaluationContextTests : BaseGameTests
    {
        #region Variables
        ...
        private void Assert_CanPlay(Predicate<AbilityEvaluationContextType> predicate)
        {
        ...
        public void Test_Can_only_play_Normal_in_Normal_context()
        {
            ...
            Assert_CanPlay(type => type == AbilityEvaluationContextType.Normal);
        }
        ...
        public void Test_Can_play_Mana_in_both_normal_and_mana_payment_context()
        {
            ...
            Assert_CanPlay(type => type == AbilityEvaluationContextType.Normal || type == AbilityEvaluationContextType.ManaPayment);
        }
        ...
        public void Test_Can_only_play_Attack_in_Attack_context()
        {
            ...
            m_mockAbility.MockedIsManaAbility = false;
            Assert_CanPlay(type => type == AbilityEvaluationContextType.Attack);
        ...
        public void Test_Can_only_play_Block_in_Block_context()
        {
            ...
            m_mockAbility.MockedIsManaAbility = false;
            Assert_CanPlay(type => type == AbilityEvaluationContextType.Block);
        ...
        public void Test_Can_only_play_Triggered_in_Triggered_context()
        {
            ...
            m_mockAbility.MockedIsManaAbility = false;
            Assert_CanPlay(type => type == AbilityEvaluationContextType.Triggered);
