...
#warning todo spell_v2 rename
    [TestFixture]
    public class PlayCardAbility2Tests : BaseGameTests
    {
        #region Inner Types

        private class MockPlayCardAbility : PlayCardAbility2
        {
        }
        ...
        private class PushAbility : Part
        {
            ...
            public PushAbility(SpellAbility2 ability)
            {
                m_ability = ability;
            }
        ...
        private class ResolveAbility : Part
        {
            ...
            public ResolveAbility(SpellAbility2 ability)
            {
                m_ability = ability;
            }
