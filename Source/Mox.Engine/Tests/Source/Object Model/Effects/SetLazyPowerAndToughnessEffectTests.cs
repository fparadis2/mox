...
{
    [TestFixture]
    public class SetLazyPowerAndToughnessEffectTests : BaseGameTests
    {
        #region Variables

        private SetLazyPowerAndToughnessEffect m_effect;
        ...
        public override void Setup()
        {
            ...
            m_effect = new SetLazyPowerAndToughnessEffect(o => new PowerAndToughness { Power = 2, Toughness = 3 });
        }
        ...
        {
            SetLazyPowerAndToughnessEffect effect = Assert.IsSerializable(m_effect);
            Assert.IsNotNull(effect);

            PowerAndToughness pt = new PowerAndToughness { Power = 3, Toughness = 10 };
            pt = effect.Modify(m_card, pt);

            Assert.AreEqual(2, pt.Power);
