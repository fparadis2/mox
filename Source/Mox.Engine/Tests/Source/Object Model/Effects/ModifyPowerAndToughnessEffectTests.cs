...
namespace Mox.Effects
{
    ...
    public class ModifyPowerAndToughnessEffectTests : BaseGameTests
    {
        ...
        {
            base.Setup();
            m_effect = new ModifyPowerAndToughnessEffect(1, -2);
        }
        ...
        {
            Assert.AreEqual(1, m_effect.PowerModifier);
            Assert.AreEqual(-2, m_effect.ToughnessModifier);
        ...
        {
            ModifyPowerAndToughnessEffect effect = Assert.IsSerializable(m_effect);
            Assert.IsNotNull(effect);

            Assert.AreEqual(m_effect.PowerModifier, effect.PowerModifier);
            Assert.AreEqual(m_effect.ToughnessModifier, effect.ToughnessModifier);
        }
