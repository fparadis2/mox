...
{
    internal class ModalChoiceEnumerator : ChoiceEnumerator
    {
        ...
        {
            ModalChoiceContext choiceContext = ((ModalChoice)choice).Context;
            ...
            {
                foreach (var modalChoice in choiceContext.Choices)
                {
