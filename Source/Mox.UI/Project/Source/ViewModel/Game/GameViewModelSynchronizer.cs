...
namespace Mox.UI
{
    public class GameViewModelSynchronizer : IDisposable
    {
        ...
        public GameViewModelSynchronizer(GameViewModel modelToSynchronizeTo, Game sourceGame, Player mainPlayer, Dispatcher dispatcher)
        {
        ...
        private ViewModel GetViewModel(Object obj)
        {
            if (obj is Card)
            {
        ...
        private CardCollectionViewModel GetCollection(Card card)
        {
            ...
            PropertyDescriptor descriptor = TypeDescriptor.GetProperties(typeof(PlayerViewModel))[card.Zone.Name];
        ...
        void Objects_CollectionChanged(object sender, Mox.Collections.CollectionChangedEventArgs<Object> e)
        {
