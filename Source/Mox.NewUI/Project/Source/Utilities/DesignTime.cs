...
namespace Mox.UI
{
    ...
    public class DesignTime
    {
        ...
        public static readonly DependencyProperty DataContextProperty = DependencyProperty.RegisterAttached("DataContext", typeof(System.Type), typeof(DesignTime), new PropertyMetadata(OnDataContextChanged));
        ...
        public static void SetDataContext(DependencyObject d, object value)
        {
            ...
            {
                element.DataContext = Activator.CreateInstance((System.Type)value);
            }
        }
        ...
        public static object GetDataContext(DependencyObject d)
        {
            ...
            return element.DataContext != null ? 
                   element.DataContext.GetType() : 
                   null;
        }
