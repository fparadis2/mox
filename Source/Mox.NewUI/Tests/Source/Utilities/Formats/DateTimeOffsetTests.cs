...
namespace Mox.UI.Tests
{
    ...
    public class DateTimeOffsetTests
    {
        ...
        {
            Assert.AreEqual("1 minute ago", new DateTimeOffset(m_now, m_now).ToString(CultureInfo.InvariantCulture));
            Assert.AreEqual("1 minute ago", new DateTimeOffset(m_now, m_now.Subtract(TimeSpan.FromSeconds(30))).ToString(CultureInfo.InvariantCulture));
